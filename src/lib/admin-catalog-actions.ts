...
async function readCourseForm(formData: FormData, currentCourseId?: string) {
  ...
  return {
    ...
    pricePln: decimalValue(formData, "pricePln"),
    regularPricePln: decimalValue(formData, "regularPricePln"),
    priceEur: decimalValue(formData, "priceEur"),
    regularPriceEur: decimalValue(formData, "regularPriceEur"),
    priceUsd: decimalValue(formData, "priceUsd"),
    regularPriceUsd: decimalValue(formData, "regularPriceUsd"),
