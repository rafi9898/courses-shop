...
export function generateMetadata(): Metadata {
  return {
    title: "Promotion on all courses | Rafał Podraza",
    description:
      "Take advantage of lower prices on all online courses. Testing, programming, AI, Cloud, DevOps, and more. Limited time offer!",
    robots: { index: true, follow: true }
  };
}

export default async function PromotionPageServer({
  params
}: {
